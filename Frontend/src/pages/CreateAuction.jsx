...
const CreateAuction = () => {
  ...
  return (
    <article className="w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] flex flex-col bg-gradient-to-r from-[#2606f822] via-[#05e92822] to-[#eb101033]">
      <h1
        className={`text-[#d6482b] text-2xl font-bold mb-2 min-[480px]:text-4xl md:text-6xl xl:text-6xl 2xl:text-6xl`}
      >
        Create Auction
      </h1>
      <div className="bg-gradient-to-r from-[#2606f822] via-[#05e92822] to-[#eb101033] mx-auto w-full h-auto px-2 flex flex-col gap-4 items-center py-4 justify-center rounded-md">
        <form
              ...
              >
                <div class="flex flex-col items-center justify-center pt-5 pb-6">
                  ...
                  <p class="text-xs text-gray-500 dark:text-gray-400">
                    SVG, PNG, JPEG, JPG (MAX. 800x400px)
                  </p>
                </div>
