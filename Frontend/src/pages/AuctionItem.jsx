        ...
        {loading ? (
          ...
          <div className="flex gap-4 flex-col lg:flex-row">
            ...
            <div className="flex-1">
              <header className="bg-slate-400 py-4 text-[24px] font-semibold px-4">
                BIDS
              </header>
              ...
              <div className="bg-[#46b939b9] py-2 text-[16px] md:text-[24px] font-semibold px-4 flex items-center justify-between rounded-2xl">
                {Date.now() >= new Date(auctionDetail.startTime) &&
                Date.now() <= new Date(auctionDetail.endTime) ? (
                  <>
                    <div className="flex gap-3 flex-col sm:flex-row sm:items-center">
                      ...
                      <input
                        type="number"
                        className="w-32 text-white focus:outline-none md:text-[20px] p-1"
                        value={amount}
                        onChange={(e) => setAmount(e.target.value)}
                      />
                    </div>
                    <button
                      className="p-4 text-4xl  text-white bg-[#4dee25e8] rounded-full transition-all duration-300 hover:bg-[#c65454]"
                      onClick={handleBid}
                    >
                      <RiAuctionFill />
                    </button>
