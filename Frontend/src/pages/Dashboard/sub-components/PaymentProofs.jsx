  ...
  export const Drawer = ({ setOpenDrawer, openDrawer }) => {
    ...
    return (
      <>
        ...
        >
          <div className="bg-white h-3/4 transition-all duration-300 w-full overflow-y-auto">
            <div className="w-full px-5 py-8 sm:max-w-[640px] sm:m-auto">
              <h3 className="text-[#D6482B]  text-3xl font-semibold text-center mb-1 rounded-md">
              ...
              <form className="flex flex-col gap-5 my-5">
                ...
                <div>
                  <Link
                    ...
                    className="bg-[#D6482B] flex justify-center w-full py-2 rounded-md text-white font-semibold text-xl transition-all duration-300  hover:text-white hover:bg-[#a12a12]"
                    target="_blank"
                  >
                    Payment Proof (SS)
                  </Link>
