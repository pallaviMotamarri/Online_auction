    ...
    return (
      <>
        {loading ? (
          ...
          <>
            <div className="w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] flex flex-col gap-10 bg-gradient-to-r from-[#2606f822] via-[#05e92822] to-[#eb101033]">
              <h1
                className={`text-[#d6482b] text-2xl font-bold mb-2 min-[480px]:text-3xl md:text-5xl xl:text-6xl 2xl:text-6xl`}
              >
                Dashboard
              </h1>
