  ...
  return (
    <>
      <section className="my-8">
        <h3 className="text-[#1e1b1b] text-xl font-semibold mb-2 min-[480px]:text-xl md:text-2xl lg:text-3xl">
          Auctions For Today
        </h3>
        <div className="flex flex-wrap gap-6">
          <div  className="bg-gradient-to-r from-[#d40cd722] via-[#87ab1923] to-[#2baad844] w-full p-2 gap-10 rounded-md flex flex-col justify-between lg:flex-1 lg:h-auto lg:p-6 2xl:flex-none 2xl:basis-64 2xl:flex-grow 2xl:px-2  2xl:py-4">
            <span className="rounded-full bg-white text-red-500 text-3xl w-fit p-4">
              <RiAuctionFill />
            </span>
            <div>
              <h3 className="text-[#d22a2a] text-xl font-semibold mb-2 min-[480px]:text-xl md:text-2xl lg:text-3xl">
                Auctions For
              </h3>
              <div>
                <h3 className="text-[#d22a2a] text-xl font-semibold mb-2 min-[480px]:text-xl md:text-2xl lg:text-3xl">
