    ...
    <>
      <section className="my-8 lg:px-5">
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full bg-white border my-5 border-gray-300 rounded-xl">
            <thead>
              <tr>
        ...
        <Link
          to={"/leaderboard"}
          className="border-2 border-stone-500 font-bold text-xl w-full py-2 flex justify-center rounded-md hover:border-stone-500 transition-all duration-300"
        >
          Go to Leaderboard
        </Link>
      </section>
