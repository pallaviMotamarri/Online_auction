...
const SubmitCommission = () => {
  ...
  return (
    <>
      <section className="bg-gradient-to-r from-[#2606f822] via-[#05e92822] to-[#eb101033] w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] flex flex-col min-h-screen py-4 justify-start">
        <div className="border-4 border-dashed border-stone-400 bg-gradient-to-r from-[#2606f822] via-[#05e92822] to-[#eb101033] mx-auto w-full h-auto px-2 flex flex-col gap-4 items-center py-4 justify-center rounded-md">
          <form
