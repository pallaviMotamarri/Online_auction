...
const SideDrawer = () => {
    ...
    return (<>
        ...
        } transition-all duration-100 p-4 flex flex-col justify-between lg:left-0 border-r-[1px] border-r-stone-500 bg-stone-300`}
      >
        <div className="relative">
          <Link to={"/"}>
            <h4 className="text-2xl font-semibold mb-4">
              <span className="text-[#e90d0d]">Bid</span>
              <span className="text-[#141316]">Master</span>
            </h4>
          </Link>
